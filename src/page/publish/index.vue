...
import { NButton, NInput, NSpace, NTag, NColorPicker, NSelect, SelectRenderTag } from 'naive-ui'
...
const clickPublishBtn = async () => {
    ...
    let res = await app.post(app.api.addArticle, { FormData: FormData, DeleteImageList: DeleteImageList })
        ...
        <div class="form_box">
            ...
            <NSpace vertical>
                ...
                <div class="add_tag_box">
                    ...
                    <NButton type="success" @click="clickAddTag" :loading="data.AddTagLoading" size="small">添加</NButton>
                </div>
            </NSpace>
            ...
            <div class="publish_box">
                <NButton type="success" @click="clickPublishBtn" :loading="data.PublishLoading">发布文章</NButton>
            </div>
        </div>
    </div>
</template>
